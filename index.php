...
<body>
		    ...
		    <div class="section-card" style="padding: 36px 0px">
		    	<div class="row">
		    		<div class="col s6">
			    		...
			    		<p style="text-align: justify; padding-right: 16px;">Sistem Pendukung Keputusan Pemilihan Smartphone ini menggunakan metode TOPSIS dengan menggunakan bahasa PHP.
				Sistem ini dibuat sebagai Tugas Akhir Mata Kuliah Sistem Pendukung Keputusan Prodi Teknik Informatika Politeknik Negeri Malang. </p>
						</div>
			    	<div class="col s6">
    ...
    <div class="modal-content">
      <h4>Tentang</h4>
      <p>Sistem Pendukung Keputusan Pemilihan Smartphone ini menggunakan metode TOPSIS dengan menggunakan bahasa PHP.
				Sistem ini dibuat sebagai Tugas Akhir Mata Kuliah Sistem Pendukung Keputusan Prodi Teknik Informatika Politeknik Negeri Malang. <br>
				<br>
				1. Dilla Hani M<br>
				2. Novan Sandi Dwi I <a href=""></a><br>
			</p>
    </div>
